        ...
        <div class="card shadow">
          ...
          <div class="card-body">
            <form novalidate method="post" action="process/login.php" autocomplete="off">
              <div class="mb-3">
                <label for="username"  class="form-label required">Enrollment No. / Teacher's ID</label>
                <input type="text" required name="username" class="form-control" id="username" placeholder="Enter Enrollment No. / Teacher's ID" autocomplete="off">
              </div>
              <div class="mb-3">
