          ...
          <h2>Categories</h2>
               ...
               <div class="row">
                    ...
                    <div class="filtering col-sm-12 text-center">
                         <a href="categories.php" target="_self"><span data-filter='*' class="active">View All</span></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="men.php" target="_self"><span data-filter='*' class="active">Men</span></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       <a href="women.php"><span data-filter='*' class="active">Female</span></a>
