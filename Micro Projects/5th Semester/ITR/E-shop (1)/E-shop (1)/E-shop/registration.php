            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  <!-- Logo image -->
                  <img
                    src="https://as2.ftcdn.net/v2/jpg/05/13/41/79/1000_F_513417977_gAVtfGelVnp6dvzkGE96NwZHnKcT6QpJ.jpg"
                    alt="">
              ...
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <!-- Registration Form -->
                  <form method="post" class="row g-3 needs-validation" action="process/register.php" novalidate>
                    <!-- Name Input -->
                    <div class="col-12">
