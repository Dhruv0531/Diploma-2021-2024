          ...
          <div class="card-body">
            ...
            <form class="row g-3" method="post" action="process/product.php" enctype="multipart/form-data">
              ...
              <div class="col-12">
                ...
                <input type="radio" name="product_categories"  id="inputNanme4"  value="Male">Men</input>
                <input type="radio" name="product_categories"  id="inputNanme4" value="Female">Women</input>
              </div>
