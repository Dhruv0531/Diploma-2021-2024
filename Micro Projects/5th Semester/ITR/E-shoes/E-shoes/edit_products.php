            ...
            <form class="row g-3" method="post" action="process/edit_prod.php?id=<?php echo $id; ?>"
              ...
              <div class="col-12">
                ...
                <select class="form-control"  name="product_categories">
                  ...
                  <option value="Men" <?php if($row['product_categories']=="Men"){ echo 'Selected';} ?>>Men</option>
                  <option value="Woman" <?php if($row['product_categories']=="Woman"){ echo 'Selected';} ?>>Woman</option>
                </select>
              </div>
              <div class="col-12">
