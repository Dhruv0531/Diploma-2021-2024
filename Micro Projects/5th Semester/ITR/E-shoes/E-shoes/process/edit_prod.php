...
if (isset($_POST['update'])) {
    ...
    $query = "UPDATE product_info SET product_name='$product_name', company_name='$company_name', product_price='$product_price',product_categories='$product_categories', product_img='$file_name' WHERE id='$id'";
