    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="getstarted scrollto" href="cart.php?pid=''">My Cart <span class="badge text-warning">(1)</span></a></li>
    ...
    <section id="products" class="team section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          $p_id=$_GET['pid'];
          $querry = "Select * from product_info where id=$p_id";
            ...
            <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="100" style="margin-bottom: 20px;">
                <div class="member d-flex align-items-start">
                  ...
                  <div class="member-info">
                    ...
                    <a class="btn btn-sm btn-danger" href="login.php">Place Order</a>
                  </div>
                </div>
            </div>
          <?php } ?>
