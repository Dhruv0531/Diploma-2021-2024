            ...
            <form class="row g-3" method="post" action="process/update_order.php?id=<?php echo $order_info['id']; ?>">
              <div class="col-12">
                ...
                <select name="product_name" class="form-control" id="product_name">
                  ...
                  while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    ?>
                    <option value="<?php echo $row['product_name'] ?>" <?php if ($order_info['product_name'] == $row['product_name'])
                         echo "selected"; ?>><?php echo $row['product_name'] ?></option>
              ...
              <div class="col-12">
                ...
                <select name="company_name" class="form-control" onchange="getPrice(this.value)">
                  ...
                  while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    ?>
                    <option value="<?php echo $row['company_name'] ?>" <?php if ($order_info['company_name'] == $row['company_name'])
                         echo "selected"; ?>><?php echo $row['company_name'] ?></option>
              ...
              <div class="col-12">
                ...
                <input type="number" name="product_price" class="form-control"
                  value="<?php echo $order_info['product_price']; ?>" id="p_price" placeholder="Enter Product Price"
                  readonly>
              </div>
              ...
              <div class="col-12">
                ...
                <input type="text" name="cust_name" class="form-control" placeholder="Enter Your Name"
                  value="<?php echo $order_info['cust_name']; ?>">
              </div>
              ...
              <div class="col-12">
                ...
                <input type="number" name="cust_mobile" class="form-control" placeholder="Enter Your Mobile Number"
                  value="<?php echo $order_info['cust_mobile']; ?>">
              </div>

              <div class="col-12">
                <label for="cust_address" class="form-label">Address</label>
                <textarea name="cust_address" class="form-control"
                  placeholder="Enter Your Address"><?php echo $order_info['cust_address']; ?></textarea>
              </div>
