                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <?php if ($_SESSION['role_id'] == 0) { ?>
                        <a href="" data-bs-toggle="modal" data-bs-target="#order_form"><i class="bi bi-send"
                            title="Order Status"></i></a>
                      <?php } ?>
                      <a href="delete_orders.php?id=<?php echo $row['id']; ?>"
...
<div class="modal fade" id="order_form" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
        ...
        <form>
          <div class="form-group">
            ...
            <select class="form-control" id="order_status"
              onchange="if(this.value=='Rejected'){$('#r_div').show();}else{$('#r_div').hide();}">
